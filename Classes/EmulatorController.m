...
extern int mfi_controller_used;
...
/*
    ...
    else
    {
        ...
        __emulation_paused = 1;
        {
            ...
            //addController.navigationController = self;
            //addController.parentViewController = self;
...
*/
    ...
    menu_exit_option  = (iCadeUsed || mfi_controller_used) && iOS_inGame;
    
    if(!menu_exit_option)
    {
        menu = [UIAlertController alertControllerWithTitle:@"CHOOSE" message:@"Choose an option from the menu. Press cancel to go back." preferredStyle:UIAlertControllerStyleAlert];
        
        UIAlertAction* optionAction = [UIAlertAction actionWithTitle:@"Options" style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) { [self showOptions]; }];
        [menu addAction:optionAction];
        UIAlertAction* defaultAction = [UIAlertAction actionWithTitle:@"Cancel" style:UIAlertActionStyleDefault handler:^(UIAlertAction * action) {  [self endMenu]; }];
    ...
    else
    {
        ...
        UIAlertAction* defaultAction = [UIAlertAction actionWithTitle:@"Exit Game" style:UIAlertActionStyleDefault handler:^(UIAlertAction * action) { iOS_exitGame = 1; [self endMenu]; }];
        [menu addAction:defaultAction];
        UIAlertAction* optionAction = [UIAlertAction actionWithTitle:@"Options" style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) { [self showOptions]; }];
        [menu addAction:optionAction];
        UIAlertAction* cancelAction = [UIAlertAction actionWithTitle:@"Cancel" style:UIAlertActionStyleDefault handler:^(UIAlertAction * action) {  [self endMenu]; }];
